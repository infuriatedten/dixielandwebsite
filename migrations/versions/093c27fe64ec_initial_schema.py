...
Revision ID: 093c27fe64ec
Revises: 5d3cb2a37503
Create Date: 2025-07-11 18:35:00.680351
...
revision = '093c27fe64ec'
down_revision = '5d3cb2a37503'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('transactions', schema=None) as batch_op:
        batch_op.add_column(sa.Column('type', sa.Enum(
            'INITIAL_SETUP', 'ADMIN_DEPOSIT', 'ADMIN_WITHDRAWAL', 'TICKET_PAYMENT', 'PERMIT_FEE',
            'MARKETPLACE_SALE', 'MARKETPLACE_PURCHASE', 'TAX_PAYMENT', 'AUTOMATED_TAX_DEDUCTION',
            'PERMIT_FEE_PAYMENT', 'AUCTION_WIN_DEBIT', 'AUCTION_SALE_CREDIT', 'OTHER',
    ...
    # end batch context here to run raw SQL

    # Explicitly alter the 'role' column with USING cast
